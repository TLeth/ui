...
class LinearPathMotion extends EasingMotion {
   ...
   */
  LinearPathMotion(Element element, Point origin, Point destination, {EasingFunction easing, int period: 500, MotionStart start, bool move(MotionState state, Point position, num x, void defaultAction()), MotionEnd end})
      : this.element = element,
        this.origin = origin,
        this.destination = destination,
        _diff = destination - origin,
        _moveCB = move,
