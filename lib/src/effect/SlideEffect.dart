...
class SlideInEffect extends ShowEffect {
   ...
   */
  SlideInEffect(Element element, {int size, int period: 500, EasingFunction easing, bool fade: true, SlideDirection direction: SlideDirection.NORTH, MotionStart start, MotionEnd end}) : super(element, createAction(element, size, fade, direction), start: start, end: end, period: period, easing: easing);
...
class SlideOutEffect extends HideEffect {
   ...
   */
  SlideOutEffect(Element element, {int period: 500, EasingFunction easing, bool fade: true, SlideDirection direction: SlideDirection.NORTH, MotionStart start, MotionEnd end}) : super(element, createAction(element, fade, direction), start: start, end: end, period: period, easing: easing);
...
class _SlideEffectUtil {
  ...
  static int leftOf(Element element) => _valueOf(element, element.style.left, (Element n) => n.offsetLeft);

  static int topOf(Element element) => _valueOf(element, element.style.top, (Element n) => n.offsetTop);

  static int widthOf(Element element) => _valueOf(element, element.style.width, (Element n) => n.offsetWidth);

  static int heightOf(Element element) => _valueOf(element, element.style.height, (Element n) => n.offsetHeight);

  static int _valueOf(Element element, String stxt, int f(Element n)) => stxt != null && stxt.endsWith("px") ? CssUtil.intOf(stxt) : f(element);
