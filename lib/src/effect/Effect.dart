...
class ShowEffect extends EasingMotion {
   ...
   */
  ShowEffect(Element element, MotionAction action, {int period: 500, EasingFunction easing, MotionStart start, MotionEnd end})
      : this.element = element,
        super(action, start: _showEffectStart(element, action, start), end: end, period: period, easing: easing);
...
class HideEffect extends EasingMotion {
   ...
   * + [end] is called when the effect ends.
   */
  HideEffect(Element element, MotionAction action, {int period: 500, EasingFunction easing, MotionStart start, MotionEnd end})
      : this.element = element,
        super(action, start: start, end: _hideEffectEnd(element, action, end), period: period, easing: easing);
...
class FadeInEffect extends ShowEffect {
   ...
   */
  FadeInEffect(Element element, {int period: 500, EasingFunction easing, num minOpacity: 0, num maxOpacity: 1, MotionStart start, MotionEnd end}) : super(element, createAction(element, minOpacity, maxOpacity), start: start, end: end, period: period, easing: easing);
...
class FadeOutEffect extends HideEffect {
   ...
   */
  FadeOutEffect(Element element, {int period: 500, EasingFunction easing, num minOpacity: 0, num maxOpacity: 1, MotionStart start, MotionEnd end}) : super(element, createAction(element, minOpacity, maxOpacity), start: start, end: end, period: period, easing: easing);
...
class ZoomInEffect extends ShowEffect {
   ...
   */
  ZoomInEffect(Element element, {int period: 500, EasingFunction easing, bool fade: true, MotionStart start, MotionEnd end}) : super(element, createAction(element, fade), start: start, end: end, period: period, easing: easing);
  ...
  static MotionAction createAction(Element element, bool fade) {
    return (num x, MotionState state) {
      ...
      if (fade) element.style.opacity = "$x";
    };
  }
...
class ZoomOutEffect extends HideEffect {
   ...
   */
  ZoomOutEffect(Element element, {int period: 500, EasingFunction easing, bool fade: true, MotionStart start, MotionEnd end}) : super(element, createAction(element, fade), start: start, end: end, period: period, easing: easing);
  ...
  static MotionAction createAction(Element element, bool fade) {
    return (num x, MotionState state) {
      ...
      if (fade) element.style.opacity = "${1-x}";
    };
  }
