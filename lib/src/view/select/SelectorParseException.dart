...
class SelectorParseException implements Exception {
  ...
  String toString() => token == null ? (index < 0 ? "Unexpected end of selector: ${this.source}" : "Unexpected character at ${this.index} in selector ${this.source}") : "Unexpected token ${this.token.type} at ${this.index} in selector ${this.source}";
