...
class Panel extends View {
  ...
  Element _createBtn(String name) => new Element.html('<div class="v-btn v-btn-$name" id="$uuid-btn-$name"></div>');
  ...
  @override
  Element render_() => new Element.html('<div class="v-shadow"><div class="v-btns" id="$uuid-btns"></div></div>');
